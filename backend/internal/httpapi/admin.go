...
// reporting must work for a guest mid-game, and the reporter is identified only
// by a salted hash of their address for dedupe.
func (h *Handler) cardReport(w http.ResponseWriter, r *http.Request) {
	...
	result, err := h.content.Report(r.Context(), input, h.proxyHeaders.clientIP(r))
	if err != nil {
